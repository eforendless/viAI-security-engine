...
const filteredSelection = toggleAllHistorySelection(new Set(["outside-filter"]), ["assessment-a", "assessment-b"]);
assert.deepEqual([...filteredSelection].sort(), ["assessment-a", "assessment-b", "outside-filter"]);
assert.deepEqual([...toggleAllHistorySelection(filteredSelection, ["assessment-a", "assessment-b"])], ["outside-filter"]);
