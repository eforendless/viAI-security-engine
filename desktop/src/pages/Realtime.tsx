...
const groups: SettingGroup[] = [
  ...
  { title: "Notifications", icon: Bell, options: [["windowsNotifications", "Enable Windows notifications", "Shows native Windows notifications for selected local events."], ["soundNotifications", "Enable notification sounds", "Allows Windows to play notification sounds."], ["notifyMediumRisk", "Investigation recommended", "Notify when a static assessment needs investigation."], ["notifyHighRisk", "High-priority investigation", "Notify when static evidence requires urgent investigation."], ["notifyUsbConnected", "USB connected", "Notify when Device Security records a USB arrival."], ["notifyUsbRemoved", "USB removed", "Notify when Device Security records a USB removal."], ["notifyScanCompleted", "Static analysis completed", "Notify when a local analysis reaches completion."]] },
];
