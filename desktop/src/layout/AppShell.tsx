import { Activity, BookOpen, Gauge, History, LayoutDashboard, Maximize2, Minus, ScanSearch, Settings, ShieldCheck, Usb, X, Zap } from "lucide-react";
...
export function AppShell() {
  ...
  return <div className="desktop-window">
    <header className="window-titlebar">
      <div className="window-titlebar-brand"><span className="window-titlebar-mark"><ShieldCheck size={16} /></span><span>viAI Desktop</span></div>
